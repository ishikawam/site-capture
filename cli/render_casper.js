...
if (system.args.length > 4) {
    // 引数 3,url 4,width(デフォルト1024) 5,height(デフォルトwidth*3/4) 6, useragent(デフォルトMac)
...
var url = urls[3];
var width = urls[4] ? parseInt(urls[4]) : 1024;
var height = urls[5] ? parseInt(urls[5]) : Math.round(width*3/4); // =768
var user_agent = urls[6] ? urls[6] : 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_9_4) AppleWebKit/537.78.2 (KHTML, like Gecko) Version/7.0.6 Safari/537.78.2'; // mac safari 1024x768
